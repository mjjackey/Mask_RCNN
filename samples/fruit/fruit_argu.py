"""
Mask R-CNN
Train on the ACFR Orchard Fruit dataset

Copyright (c) 2019 University of Southampton .
Licensed under the MIT License (see LICENSE for details)
Written by Jing Meng
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    # Train a new model starting from pre-trained COCO weights(ResNet101)
    python3 fruit_argu.py train --dataset=./apples/ --weights=coco --epoch=15

    # Resume training a model that you had trained earlier
    python3 fruit_argu.py train --dataset=./apples/ --weights=last --epoch=25 --layers='all'

    # Train a new model starting from ImageNet weights(ResNet50)
    python3 fruit_argu.py train --dataset=./apples/ --weights=imagenet --epoch=15
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--layers', required=False, default= 'heads',choices=['heads','3+','4+','5+','all'],
